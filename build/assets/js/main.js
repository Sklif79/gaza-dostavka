...
(function ($, window, document) {
    ...
    function columnHeight(el) {
        var $columns = $(el).find('.advantages-graphical-chart__column'),
            ...
            maxvalue = parseFloat($(this).find('.advantages-graphical-chart__row:first-of-type').get(0).html().replace(/\s/g, ''))
        //
        // minValue = parseFloat($(el).find('.advantages-graphical-chart__row:last-of-type span')
        // .html().replace(/\s/g, ''))
        ;

        console.log($(el).find('.advantages-graphical-chart__row:first-of-type span').get(0));
        ...
        for (i = 0; i < $columns.length; i++) {
            ...
            // columnValue = $columns[i].data('value');
            // console.log(columnValue)
        }

        // console.log('columnMaxHeight: ' + columnMaxHeight);
